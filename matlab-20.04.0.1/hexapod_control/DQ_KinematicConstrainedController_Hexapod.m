...
classdef DQ_KinematicConstrainedController_Hexapod< DQ_KinematicController_for_Hexapod
    ...
    methods
        function controller = DQ_KinematicConstrainedController_Hexapod(robot)
            controller = controller@DQ_KinematicController_for_Hexapod(robot);
