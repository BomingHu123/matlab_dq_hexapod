...
classdef DQ_MultiLeggedRobotBody < DQ_Kinematics
    ...
    methods
        ...
        function x = fkm(obj,q,num_of_chain,ith)
            ...
            elseif nargin == 3
                if num_of_chain ~= 0
                    x = obj.reference_frame * DQ(q(1:8)) * obj.frame_bias{num_of_chain + 1} * raw_fkm_absolute(obj,q,num_of_chain);
                else
                ...
                x_absoulute_pose = obj.reference_frame * obj.reference_to_first_feethold * first_cortch_to_first_feethold' * obj.frame_bias{2}';
        ...
        function set_reference_to_first_feethold(obj, q)
            ...
            reference_to_first_leg = reference * x_base_to_first_leg;
        ...
        function J = raw_pose_jacobian_absolute(obj,q)
            ...
            %                 Q1 = q(j : j + dim - 1);
            %                 j = j + dim;
            %                 dim = obj.chain{2}.get_dim_configuration_space();
            %                 Q2 = q(j : j + dim - 1);
            %             else
            %                 error('wrong type')
            %             end
...
%             constraint_matrix = J_whole(:,9:26);
        ...
        function [x_current_abs_pose,EBV] = get_estimated_base(obj,q,last_q, sampling_time)
            if nargin > 4
                ...
                first_cortch_to_first_feethold_last = raw_fkm_absolute(obj,last_q,1);
                x_last_abs_pose = obj.reference_frame * obj.reference_to_first_feethold * first_cortch_to_first_feethold_last' * obj.frame_bias{2}';
