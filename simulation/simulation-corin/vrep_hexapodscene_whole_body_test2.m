...
function [Foothold1_to_foothold2_vrep_trans, Foothold2_to_foothold3_vrep_trans, Foothold3_to_foothold4_vrep_trans, Foothold4_to_foothold5_vrep_trans, Foothold5_to_foothold6_vrep_trans,...
    ...
    Foothold5_to_foothold6_matlab_trans,Body_copp_vrep_trans,Body_matlab_trans,Norm_of_error]= vrep_hexapodscene_whole_body_test2(simulation_parameters)
...
last_corin_base = vi.get_object_pose('/hexapod');
Norm_of_error = [];
