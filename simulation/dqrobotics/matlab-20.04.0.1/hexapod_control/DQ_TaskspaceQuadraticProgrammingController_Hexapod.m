...
classdef DQ_TaskspaceQuadraticProgrammingController_Hexapod < DQ_KinematicConstrainedController_Hexapod
    ...
    methods
        ...
        function [u,norm_task_error] = compute_setpoint_control_signal(controller, q, task_reference, footTip0_velocity)
...
%                 J = J_wb;
                ...
                norm_task_error = norm(task_error)
                ...
                H = controller.compute_objective_function_symmetric_matrix_hexapod(J, task_error);
...
%                 f = controller.compute_objective_function_linear_component(J, task_error);
                f = controller.compute_objective_function_linear_component_hexapod(J, task_error,Ja,footTip0_velocity);
