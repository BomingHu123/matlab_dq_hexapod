...
function vrep_scene_dqcontroller_dynamcis(simulation_parameters)
...
lwr4_q_vector = zeros(lwr4.get_dim_configuration_space(), ...
    max_iterations);
lwr4_q_dot_vector = zeros(lwr4.get_dim_configuration_space(), ...
    max_iterations);

% index of the auxiliary arrays used to plot data
ii = 1;
last_lwr4_q = lwr4_vreprobot.get_q_from_vrep();
lwr4_q_constant = lwr4_vreprobot.get_q_from_vrep();
%% Control loop
for t=0:sampling_time:total_time
    vi.synchronous_trigger();
    lwr4_q = lwr4_vreprobot.get_q_from_vrep();
    lwr4_q_dot = (lwr4_q - last_lwr4_q)/sampling_time;
    %% Compute control signal for the arm
    lwr4_u  = [0;0;0;0;0;0;0];
    last_lwr4_q = lwr4_q;
    ...
    %% Send desired values
    lwr4_vreprobot.send_target_joint_to_vrep(lwr4_q);
    ...
    lwr4_q_dot_vector(:,ii) = lwr4_q_dot;
...
figure(1)
plot(T,lwr4_control_inputs(1,:))
hold on
plot(T,lwr4_q_dot_vector(1,:),':')
hold on
title('control input u and last qdot for joint1')
xlabel('Time/s') 
ylabel('control input u for joint 1') 
legend('control input u of joint 1','last qdot of joint 1')

figure(2)
plot(T,lwr4_control_inputs(2,:))
hold on
plot(T,lwr4_q_dot_vector(2,:),':')
hold on
title('control input u and last qdot for joint2')
xlabel('Time/s') 
ylabel('control input u for joint 2') 
legend('control input u of joint 2','last qdot of joint 2')

figure(3)
plot(T,lwr4_control_inputs(3,:))
hold on
plot(T,lwr4_q_dot_vector(3,:),':')
hold on
title('control input u and last qdot for joint3')
xlabel('Time/s') 
ylabel('control input u for joint 3') 
legend('control input u of joint 3','last qdot of joint 3')

figure(4)
plot(T,lwr4_control_inputs(4,:))
hold on
plot(T,lwr4_q_dot_vector(1,:),':')
hold on
title('control input u and last qdot for joint4')
xlabel('Time/s') 
ylabel('control input u for joint 4') 
legend('control input u of joint 4','last qdot of joint 4')

figure(5)
plot(T,lwr4_control_inputs(5,:))
hold on
plot(T,lwr4_q_dot_vector(5,:),':')
hold on
title('control input u and last qdot for joint5')
xlabel('Time/s') 
ylabel('control input u for joint 5') 
legend('control input u of joint 5','last qdot of joint 5')

figure(6)
plot(T,lwr4_control_inputs(6,:))
hold on
plot(T,lwr4_q_dot_vector(6,:),':')
hold on
title('control input u and last qdot for joint6')
xlabel('Time/s') 
ylabel('control input u for joint 6') 
legend('control input u of joint 6','last qdot of joint 6')

figure(7)
plot(T,lwr4_control_inputs(7,:))
hold on
plot(T,lwr4_q_dot_vector(7,:),':')
hold on
title('control input u and last qdot for joint7')
xlabel('Time/s') 
ylabel('control input u for joint 7') 
legend('control input u of joint 7','last qdot of joint 7')
